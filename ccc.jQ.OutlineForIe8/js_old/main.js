jqapi = function () {
    ...
    var values = {
        ...
        title: ' - jQuery API中文文档(适用jQuery 1.0 - jQuery 2.0) '
    };
    ...
    function formatArticle() {
        var pDesc = $('http://www.css88.com/jqapi-1.9/js_old/p.desc', elements.content);
    ...
    function buildDemos() {
        $( ".entry-example" ).each(function() {
            		...
            		iframeSrc = src.find( "http://www.css88.com/jqapi-1.9/js_old/td.code .line" ).map(function() {
...
$(document).ready(function () {
    var navigation_el = $('#navigation').load('http://www.css88.com/jqapi-1.9/js_old/navigation_old.html', function () { //load the navigation (not static because it gets generated with the api scraping)
        jqapi.initialize();
    });
